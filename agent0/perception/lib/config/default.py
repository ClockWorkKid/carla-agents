...
_C.MODEL = CN()
_C.MODEL.NAME = 'ddrnet_23_slim'
_C.MODEL.PRETRAINED = 'perception/pretrained_models/best_val_smaller.pth'
...
_C.TEST.MODEL_FILE = 'perception/pretrained_models/best_val_smaller.pth'
_C.TEST.FLIP_TEST = False
_C.TEST.MULTI_SCALE = False
_C.TEST.SCALE_LIST = [1]

_C.TEST.OUTPUT_INDEX = 0
